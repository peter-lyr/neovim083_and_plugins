...
s('n', '\\q', function() test('') end, { silent = true})
s('n', '\\w', function() test('ipython') end, { silent = true})
s('n', '\\e', function() test('bash') end, { silent = true})
s('n', '\\r', function() test('powershell') end, { silent = true})
