...
s({'n', 'v'}, '<leader><leader>fa', function() telescope_exe("builtin") end, {silent = true})
s({'n', 'v'}, '<leader>fo', function() telescope_exe("oldfiles") end, {silent = true})
s({'n', 'v'}, '<leader><leader>fh', function() telescope_exe("help_tags") end, {silent = true})
s({'n', 'v'}, '<leader><leader>fl', function() telescope_exe("colorscheme") end, {silent = true})
s({'n', 'v'}, '<leader>fc', function() telescope_exe("command_history") end, {silent = true})
s({'n', 'v'}, '<leader><leader>fg', function() telescope_exe("commands") end, {silent = true})
s({'n', 'v'}, '<leader>gf', function() telescope_exe("git_files") end, {silent = true})
s({'n', 'v'}, '<leader><leader>gc', function() telescope_exe("git_commits") end, {silent = true})
s({'n', 'v'}, '<leader><leader>gb', function() telescope_exe("git_bcommits") end, {silent = true})
s({'n', 'v'}, '<leader>gb', function() telescope_exe("git_branches") end, {silent = true})
